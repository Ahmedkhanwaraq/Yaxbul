...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Abdullahi abdinur 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : SOMALIA
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : Mustacsim2006
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : DJMALID
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [DUDE_OLD] : %s/%s -> \033[0;92m [DuDe-OK:%s ]- \033[0;91m[DUDE-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
